...
export const preferences = {
	data: {
		...
		desktopNotificationsChannels: 'default',
		desktopNotificationsGroups: 'default',
		desktopNotificationsDirects: 'default',
		mobilePushNotificationsChannels: 'default',
		mobilePushNotificationsGroups: 'default',
		mobilePushNotificationsDirects: 'default',
		enableAutoAway: true,
		highlights: [],
