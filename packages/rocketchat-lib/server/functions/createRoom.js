...
export const createRoom = function(type, name, owner, members, readOnly, extraData = {}, options = {}) {
	...
	owner = Users.findOneByUsername(owner, { fields: { name: 1, username: 1 } });
	if (!owner) {
	...
	for (const username of members) {
		const member = Users.findOneByUsername(username, { fields: { name: 1, username: 1, 'settings.preferences': 1 } });
