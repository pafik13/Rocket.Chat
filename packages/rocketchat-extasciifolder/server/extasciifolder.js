...
// applications. See rocketchat-folder-tests.js for an example of importing.
export const name = 'rocketchat:extasciifolder';
...
ExtASCIIFolder.mapping = new Map([
	[0x410, 'a'],
	[0x430, 'a'],
	[0x412, 'b'],
	[0x432, 'b'],
