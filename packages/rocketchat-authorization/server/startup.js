...
Meteor.startup(function() {
	...
	const permissions = [
		...
		{ _id: 'complain-c',                    roles : ['admin', 'user', 'bot'] },
		{ _id: 'complain-d',                    roles : [] },
		{ _id: 'complain-p',                    roles : ['admin', 'user', 'bot'] },
		{ _id: 'complain-u',                    roles : ['admin', 'user', 'bot'] },
		{ _id: 'delete-c',                      roles : ['admin', 'owner'] },
		{ _id: 'delete-d',                      roles : ['admin', 'user'] },
		...
		{ _id: 'force-delete-message',          roles : ['admin', 'owner', 'moderator'] },
		...
		{ _id: 'view-file-list',                roles : ['admin', 'owner', 'moderator'] },
