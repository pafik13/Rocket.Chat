	...
	if (typeof chrome !== 'undefined' && chrome.gcm) {
		...
		if (options.apn) {
			...
			Meteor.startup(function() {
				...
				const permissionData = window.safari.pushNotification.permission(options.apn.websitePushId);
		...
		function setupAppRegistrations() { // jshint ignore: line
			...
			const requestAccess = navigator.push.register();
